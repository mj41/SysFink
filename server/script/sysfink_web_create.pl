...
sysfink_web_create.pl [options] model|view|controller name [helper] [options]
 ...
 Examples:
   ...
   sysfink_web_create.pl model SomeDB DBIC::Schema MyApp::Schema create=dynamic\
   dbi:SQLite:/tmp/my.db
   sysfink_web_create.pl model AnotherDB DBIC::Schema MyApp::Schema create=static\
